...
#define DEFAULT_ANSI_COLOURS                                        \
	{                                                               \
		0x00000000, 0x00AA0000, 0x0000AA00, 0x00AA5500, 0x000000AA, \
		    0x00AA00AA, 0x0000AAAA, 0x00AAAAAA                      \
	}
#define DEFAULT_ANSI_BRIGHT_COLOURS                                 \
	{                                                               \
		0x00555555, 0x00FF5555, 0x0055FF55, 0x00FFFF55, 0x005555FF, \
		    0x00FF55FF, 0x0055FFFF, 0x00FFFFFF                      \
	}
...
#define DEFAULT_MARGIN_GRADIENT 4
	...
	struct term_t;
	typedef void (
	    *callback_t)(struct term_t *, uint64_t, uint64_t, uint64_t, uint64_t);
	typedef size_t fixedp6;

	static inline size_t fixedp6_to_int(fixedp6 value) { return value / 64; }
	static inline fixedp6 int_to_fixedp6(size_t value) { return value * 64; }
	...
	void term_vbe(struct term_t *term,
	...
	void term_move_character(struct term_t *term,
	                         size_t new_x,
	                         size_t new_y,
	                         size_t old_x,
	                         size_t old_y);
